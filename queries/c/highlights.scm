...
(declaration
  type: (type_identifier) @_type
  declarator: (init_declarator (_) @label) (#set! priority 127))
...
([
  ...
  "continue"
  "break"
] @keyword.repeat (#set! priority 130))
...
([
  ...
  "case"
  "switch"
] @keyword.conditional (#set! priority 130))
...
([
  ...
  "#elifndef"
  (preproc_directive)
] @keyword.directive (#set! priority 130))


("#define" @keyword.directive.define (#set! priority 130))

("#include" @keyword.import (#set! priority 130))
...
((number_literal) @number (#set! priority 130))
...
(declaration
  ((type_qualifier) @label (#set! priority 130))
  type: ((type_identifier) @type (#set! priority 130))
  (_ (identifier)) @type
  (_))
