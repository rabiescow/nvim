...
vim.api.nvim_create_autocmd(
    { "VimEnter", "BufNewFile", "BufReadPre", "BufEnter", "BufFilePost", "BufFilePre", "FileType" }, {
        group = vim.api.nvim_create_augroup("LspStartup", { clear = true }),
        pattern = "*",
        desc = "Starts up LSP upon detecting filetype",
        callback = function(args)
            -- vim.notify("Looking for LSP...")
            local servers = {
                bash = "bashls",
                c = "clangd",
                cpp = "clangd",
